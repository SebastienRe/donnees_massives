...
# this is the default:
export HDFS_NAMENODE_OPTS="-Dhadoop.security.logger=INFO,RFAS -Dhdfs.audit.logger=INFO,NullAppender"
...
# and therefore may override any similar flags set in HADOOP_OPTS
#
export HDFS_BALANCER_OPTS="-Dhadoop.security.logger=INFO,RFAS"
